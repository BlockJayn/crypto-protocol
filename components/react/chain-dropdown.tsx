...
const SelectOptions = ({ data, value, onChange }: ChangeChainMenuType) => {
  ...
  const customStyles = {
    ...
    clearIndicator: (provided: SystemStyleObject) => ({
      ...provided,
      borderRadius: 'full',
      color: useColorModeValue('color.lightblue', 'whiteAlpha.600')
    }),
    ...
    return (
      <chakraComponents.DropdownIndicator {...props}>
        <Icon
          ...
          w={6}
          h={6}
          color={useColorModeValue('color.white', 'color.white')}
        />
    ...
    return (
      <chakraComponents.Option {...props}>
        <Stack
          ...
          overflow="hidden"
          wordBreak="break-word"
          color={useColorModeValue('color.dark', 'color.white')}
          w="full"
        >
          <Box
            minW={10}
            ...
            h="full"
            border="1px solid"
            borderColor={useColorModeValue('color.lighter', 'whiteAlpha.200')}
            borderRadius="full"
            overflow="hidden"
          >
            <Image
